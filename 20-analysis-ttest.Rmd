...
> The mean petal length of the samples was `r pm(irisout$Petal.Length_mean, irisout$Petal.Length_se)`, whereas the mean sepal length was `r pm(irisout$Sepal.Length_mean, irisout$Sepal.Length_se)`.
A Welch'S t-test revealed that there was statistical significance in the differences between the two sites (t~(`r sprintf("%0.2f", dset_test$parameter)`)~ = `r sprintf("%2.3f", dset_test$statistic)`; `r pval(dset_test$p.value)`) at a significance level of $\alpha=$ 0.05.
